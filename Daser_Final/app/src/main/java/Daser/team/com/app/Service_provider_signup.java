...
public class Service_provider_signup extends AppCompatActivity {


    EditText fname, lname, email, phone, password, addr1, addr2, state, city, zip, country,dob,orgn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ab.setTitle(" Service Provider Signup");
        ...
        orgn = (EditText) findViewById(R.id.org_name);
    ...
    public void providersignup(View view) {
        ...
        String s_orgname = orgn.getText().toString();
        ...
        else if(s_orgname.isEmpty())
        {
            Toast.makeText(getApplicationContext(),"Organization should not empty.!",Toast.LENGTH_LONG).show();
        }
        ...
        {
            new Service_provider_signup.BackgroundSignup().execute(firstname, lastname, mailaddr, phonenum, pass, address1, address2, s_state, s_city, zipcode, s_country,s_dob,s_orgname);
...
*/
            ...
            progressDialog = ProgressDialog.show(Service_provider_signup.this, "Loading...",
                    "Seller signup processing, please wait...", false, false);
        }
